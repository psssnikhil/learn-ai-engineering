...
import { syncNav } from './generate-nav.mjs';
...
function main() {
  ...
  writeLearningPathFromMigrate(learningPathRows);
  syncNav();
...
function writeLearningPathFromMigrate(rows) {
  // learning-path.md is generated by syncNav() from curriculum.yml
}
...
function buildNavYaml(navByPhase) {
  // Deprecated — nav comes from curriculum.yml via generate-nav.mjs
  return '';
}

function updateMkdocs(navYaml) {
  // Deprecated — use syncNav()
}
