...
| 6 | [Overfitting, Regularization & Dropout](lessons/06-overfitting-regularization.md) | 30 min | intermediate |
| 7 | [Building a Neural Network from Scratch](lessons/07-building-nn-from-scratch.md) | 60 min | intermediate |
| 8 | [Convolutional Neural Networks (CNNs)](lessons/08-cnns-intro.md) | 45 min | intermediate |
| 9 | [Recurrent Neural Networks (RNNs) & LSTMs](lessons/09-rnns-lstms.md) | 35 min | intermediate |
| 10 | [Training Best Practices & Optimization](lessons/10-training-best-practices.md) | 40 min | intermediate |
